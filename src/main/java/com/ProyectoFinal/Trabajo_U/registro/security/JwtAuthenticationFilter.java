package com.ProyectoFinal.Trabajo_U.registro.security;
...
import com.ProyectoFinal.Trabajo_U.registro.service.UserDetailsServiceImpl;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // Inyecta el servicio de detalles del usuario para cargar la información del
    // usuario
    ...
    // Este método se encarga de verificar el token JWT y establecer la
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                // Si el token es válido, carga los detalles del usuario utilizando el nombre de
                // usuario extraído del token
                // y establece la autenticación del usuario en el contexto de seguridad de
                // Spring
        ...
        // Continúa con la cadena de filtros para que la solicitud sea procesada por el
        // siguiente filtro o controlador
        // en la cadena de filtros de Spring Security
        filterChain.doFilter(request, response);
    }

    // Método para extraer el token JWT del encabezado de autorización de la
    // solicitud HTTP
    ...
    private String parseJwt(HttpServletRequest request) {
        ...
        // "
        // Si el encabezado tiene el prefijo "Bearer ", extraer el token JWT del
        // encabezado
