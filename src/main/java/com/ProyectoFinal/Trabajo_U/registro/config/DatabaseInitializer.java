package com.ProyectoFinal.Trabajo_U.registro.config;
...
@Component
// Esta clase se encarga de inicializar la base de datos con roles y un usuario
// administrador por defecto
// al iniciar la aplicación. Implementa CommandLineRunner para ejecutar código
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    // Este método se ejecuta al iniciar la aplicación y se encarga de inicializar
    // los roles y el usuario administrador
    ...
    private void inicializarRoles() {
        if (rolRepository.count() == 0) {
            ...
            rolEstudiante.setNombre(Rol.NombreRol.ROL_FUNCIONARIO);
    ...
    // Este usuario tendrá el username "admin", password "admin123" y el rol de
    // administrador
